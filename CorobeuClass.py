...
class Corobeu():
    ...
    def __init__(self, port=19999, name='robot01', motor_E='motorL01', motor_D='motorR01'):
        """
        ...
        """
        self.clientID, self.robot, self.motorE, self.motorD, self.ball = self.connect_CRB(port, name, motor_E, motor_D)
        self.yOut = []
        self.xOut = []
        self.phi = 0
        self.phi_obs = 0
